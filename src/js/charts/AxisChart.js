...
export default class AxisChart extends BaseChart {
	...
	configure(options) {
		...
		this.config.xIsMultiLineLabel = options.axisOptions.xIsMultiLineLabel || 0;
		...
		let componentConfigs = [
			...
			[
				'xAxis',
				{
					...
					height: this.height,
					splitInLines: this.config.xIsMultiLineLabel
					// pos: 'right'
				},
				function() {
					let s = this.state;
					s.xAxis.calcLabels = this.config.xIsMultiLineLabel
						? s.xAxis.labels
						: getShortenedLabels(this.width, s.xAxis.labels, this.config.xIsSeries);
					return s.xAxis;
				}.bind(this)
			],
